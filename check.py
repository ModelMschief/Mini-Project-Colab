...
def extract_lines(words, page_index, start_line_index, threshold=1):
    lines = []
...
if __name__ == "__main__":
    pdf_path = "modularity\\doc.pdf"  # Replace with your PDF file path
    pdf = 'modularity\\AISupportSystem.pdf'
    para_head_dict1 = main(pdf_path)
    para_head_dict = main(pdf)

    print(f'Final insights for {pdf_path}: {para_head_dict1}')
    print(f'Final insights for {pdf}: {para_head_dict}')